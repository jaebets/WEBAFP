...
if (isset($_POST['ENREGISTRER'])) {
 ...
 $_SESSION['idverba'] = $_POST['duplicata_css'];
                ...
                <div class="main-content">
                    <div class="container">
                        ...
                        <div class="row " style="margin-top: 2.5%; border-bottom: 2px solid #8C001A;">
                            <form name="fiche_verb" method="POST" action="recu_caisse_dupl.php"> 
                                <div class="col-sm-3" >
                                                    ...
                                                    <td colspan="1">
                                                      <div align="left">
                                                        <label class="checkbox-inline" for="form-field-5">
                                                            ...
                                                            <td>
                                                              <input style="width: 100%" type="text" name="MODE_REGLEMENT" readonly="readonly" class="form-control" id="cpt" readonly="true" value="ESPECE"/>
                                                            </td>
                                                        </label>                                                                                                                  
                                                      </div>
                                                    </td>
