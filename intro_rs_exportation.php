                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <a href = "liste_verbalisation.php" class="btn btn-icon btn-block">
                                                    <i class="clip-truck"></i>
                                                    EXPORTER LISTE DE VERBALISATIONS <span class="badge badge-danger"> <i class="clip-truck"></i> </span>
                                                </a>
                                            </div>
                                            <div class="col-sm-4">
                                                <a href = "liste_paiement.php" class="btn btn-icon btn-block">
                                                    <i class="fa fa-shopping-cart "></i>
                                                    EXPORTER LISTE DE PAIEMENTS<span class="badge badge-danger"> <i class="fa fa-shopping-cart "></i> </span>
                                                </a>
                                            </div>
                                            <div class="col-sm-4">
                                                <a href = "verbalisation_siege.php" class="btn btn-icon btn-block">
                                                    <i class="clip-truck"></i>
                                                    VERBALISATIONS SIEGE<span class="badge badge-danger"> <i class="clip-truck"></i> </span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="btn btn-red dropdown-toggle" >
                                    <a href="intro_respo_site.php"  style="text-decoration:none;color: #ffffff;">
