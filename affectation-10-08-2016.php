...
//Enregistrement de l'affectation
    $reqinsert1 = "INSERT INTO [dbo].[AFFECTER]([ID_USER],[ID_CAISSE],[ID_SESSION],[DATE_AFFECTATION],[MONTANT_POURVU],[MONTANT_ENCAISSE],[MONTANT_POURVU_RESTANT])VALUES(:ID_USER,:ID_CAISSE,:ID_SESSION,:DATE_AFFECTATION,:MONTANT_POURVU,:MONTANT_ENCAISSE,:MONTANT_POURVU_RESTANT)";
    $ins1 = $conn->prepare($reqinsert1);
    $ins1->execute(array(':ID_USER' => $id_user, ':ID_CAISSE' => $id_caisse, ':ID_SESSION' => $id_session, ':DATE_AFFECTATION' => $datetoday, ':MONTANT_POURVU' => $montant_appro, ':MONTANT_ENCAISSE' => 0, ':MONTANT_POURVU_RESTANT' => 0));
