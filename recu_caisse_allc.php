...
if ($mttapaye <= 0) {
    ...
    echo"<script>
                   ...
                   window.location.href = 'fiche_verbalisation_allc.php';
                 </script>";
}
   ...
   // echo " B " . $reqest['ID_COMPTE_CLIENT'];
    ...
    if (empty($reqest['ID_COMPTE_CLIENT'])) {
        ...
        echo" <script>
					 ...
					 window.location.href = 'detail_verbalisation_allc.php';
				  </script>";
...
<?php ?>
    ...
    <div class="modal-footer">
        ...
        <a class="btn btn-red btn-lg" href="fiche_verbalisation_allc.php">
            ANNULER
