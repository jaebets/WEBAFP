                            ...
                            if ($app_ext_sur == 1) {
                                ...
                                <div class="row" style="margin-top: 0.5%; border-bottom: 2px solid #8C001A;">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        $sql = $dbh->query('select max((e."poidsMesure_EP"*(0.99))-e."poidsMax_EP") as "high" ,e."nom_EP" as "bigest_overload_ep"
...
and p."Numero_Pesee"= ' . $_SESSION['num_pesee'] . ' group by g."nom_GP" order by "high_gp" desc rows 1');
										...
										//
										$sql_gp2 = $dbh->query('select  max((g."poids_GP"*(0.99))-g."poidsMax_GP") as "high_gpT",    g."nom_GP" as "bigest_overload_gp2"
 from "Mobile_Pese" a,"Group_Pese" g,"Vehicule_Pese" v,"Pesee" p 
where g."id_MP"=a."id_MP" 
and a."id_VP"=v."id_VP" and 
p."Id_VP"=v."id_VP" 
