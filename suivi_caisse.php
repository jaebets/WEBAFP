...
$sess=$_GET['id_session'];
$ut=$_GET['id_user'];
$id_csse=$_GET['id_caisse'];
?>
<!DOCTYPE html>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="page-header">
                                <h1>
                                    RESPONSABLE CAISSE <small>details encaissement </small></h1>
                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane in active" id="panel_tab2_example1">
                                    ...
                                    <div id="imp">
                                    <strong>LISTES DES ENCAISSEMENTS EFFECTUES A LA CAISSE <?php echo $id_csse; ?> pour la session <?php echo $sess; ?> </strong>
                                    <table width="100%" border="1" class="table table-striped table-bordered table-hover table-full-width">
                                        ...
                                        $lispaiement=$conn->query("SELECT [PAIEMENT].[ID_VERB],[PAIEMENT].[ID_USER],[NUMERO_PESE],[ID_CAISSE],[DATE_VERB],[AMENDE_TOTAL],[MONTANT_RESTANT],[ID_PAIEMENT],[MONTANT_PAIEMENT],[DATE_PAIEMENT],[ID_SESSION]FROM [Afriquepesage].[dbo].[VERBALISATION],[Afriquepesage].[dbo].[PAIEMENT] where [VERBALISATION].[ID_VERB]=[PAIEMENT].[ID_VERB] AND [PAIEMENT].[ID_USER]='".$ut."' and [DATE_PAIEMENT]='".$dta."' AND [ID_CAISSE]='".$id_csse."' AND [ID_SESSION]='".$sess."'");
                                    ...
                                    <?php
                                    $dtx=date("Ymd");
                                    $totencaiss=$conn->query("SELECT SUM([MONTANT_PAIEMENT]) as [TOTAL_PAIEMENT]FROM [Afriquepesage].[dbo].[PAIEMENT] where  [PAIEMENT].[ID_USER]='".$ut."' and [DATE_PAIEMENT]='".$dtx."' AND [ID_CAISSE]='".$id_csse."' AND [ID_SESSION]='".$sess."'"); 
