...
$tolerance = $infos['TOLERANCE'];
$tonnage = $infos['Tonnage'];
  $ratio = $infos['Ratio'];
$app_tolerance = $infos['ApplicationTolerance'];
$type_tolerance = $infos['type_tolerance'];
$BDWIM = $infos['BDWIM'];
...
if (isset($_POST['tolerance'])) {
    $sql = "UPDATE [dbo].[ADMIN_PARAM] SET [TOLERANCE] = ? ,[ApplicationTolerance] = ? ,[type_tolerance] = ? WHERE [IDPARAM] = 1";
    $q = $conn->prepare($sql);
    $q->execute(array($_POST['tol'], $_POST['app_tol'], $_POST['type_tolerance']));
    if ($q) {
        /*         * *****************************JOURAL ENTRY****************** */
        $login_log = fopen("assets/log/parametrage/journal" . date('d-m-Y'), "a+") or die("Unable to open file!");
        $log = "*" . date('d-m-Y H:i:s') . ": Modification de la tolerance par *" . preg_replace('/\s+/', '', $_SESSION['nom']) . ' *' . preg_replace('/\s+/', '', $_SESSION['prenoms']) . ' *' . $_SESSION['libelle'] . " \n\n";
        fwrite($login_log, $log);
        fclose($login_log);
        /*         * *************************************************************** */
        echo "<script>
                ...
                <div class="modal-body">
                    <div class="tabbable">
                        <ul id="myTab" class="nav nav-tabs tab-bricky">
                            ...
                            <li>
                                <a href="#panel_tab2_example_tolerance" data-toggle="tab">
                                    TOL&Eacute;RANCE
                                </a>
                            </li>
                            <!--<li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="panel_tab2_example_tolerance">
                                <form method="post" action="">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <table width="100%" border="0">
                                                ...
                                                if ($app_tolerance == 0) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label class="col-sm-10 control-label" for="form-field-5">
                                                                VOULEZ-VOUS APPLIQUER LA TOL&Eacute;RANCE ?
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <label style="color:#FF2E12"><b>TOL&Eacute;RANCE NON APPLIQU&Eacute;E</b></label>
                                                            <select id="form-field-1" name="app_tol" class="form-control">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label class="col-sm-10 control-label" for="form-field-5">
                                                                APPLIQUER LA TOL&Eacute;RANCE SUR :
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <select id="form-field-1" name="type_tolerance" class="form-control">
                                                                <option value="0">ESSIEUX</option>
                                                                <option value="1">PTAC</option>
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input id="form-field-1" class="form-control" name="tol" value="<?php echo $tolerance; ?>" type="text" placeholder="" onkeyup="valid(this)" onblur="valid(this)"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="col-sm-10 control-label" for="form-field-5">
                                                                RATIO (%):
                                                            </label></td>
                                                        <td><input id="form-field-1" class="form-control" name="ratio" value="<?php echo $ratio; ?>" type="text" placeholder="" onkeyup="valid(this)" onblur="valid(this)"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="col-sm-10 control-label" for="form-field-5">
                                                                TONNAGE (KG):
                                                            </label></td>
                                                        <td><input id="form-field-1" class="form-control" name="tonnage" value="<?php echo $tonnage; ?>" type="text" placeholder="" onkeyup="valid(this)" onblur="valid(this)"/></td>
                                                    </tr>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <tr>
                                                        <td><label class="col-sm-10 control-label" for="form-field-5">
                                                                VOULEZ-VOUS ANNULER L'APPLICATION DE LA TOL&Eacute;RANCE ?
                                                            </label></td>
                                                        <td>
                                                            <label style="color:#FF2E12"><b>TOL&Eacute;RANCE APPLIQU&Eacute;E SUR 
                                                                    <?php
                                                                    if ($type_tolerance != 0) {
                                                                        ?>
                                                                        PTAC
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input id="form-field-1" class="form-control" name="tol" value="<?php echo $tolerance; ?>" type="text" placeholder="" onkeyup="valid(this)" onblur="valid(this)"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="col-sm-10 control-label" for="form-field-5">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="tolerance" class="btn btn-primary">
                                            ENREGISTRER
                                        </button>
                                    </div>
                                </form>
