...
?>
                    ...
                    <div class="row " style="margin-top: 2.5%; border-bottom: 2px solid #8C001A;">
                        <form name="fiche_verb" method="POST" action="recu_caisse_controle.php"> 
                            <div class="col-sm-3" >
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <table width="100%" border="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="AMENDE_TOTAL" id="mt0" placeholder="" readonly="readonly" class="form-control" value="<?php echo $retrieve['AMENDE_TOTAL']; ?>"/>
                                                </td>
                                            </tr>
											<tr>
                                                <td><label class="col-sm-10 control-label" for="form-field-5">
                                                ...
                                                <td>
                                                    <input type="text" name="MONTANT_DEJA_ENCAISSE" id="mtdeja" placeholder=""  onchange="restfunc('mt0', 'mtdeja','mt', 'mp', 'mr', 'apt');" class="form-control" value="<?php echo $retrieve['AMENDE_TOTAL']; ?>"/>
                                                </td>
                                            </tr>
											
											<tr>
                                                <td><label class="col-sm-10 control-label" for="form-field-5">
                                                        TOTAL &Agrave;  FACTURER:
                                                    </label></td>
                                                <td>
                                                    <input type="text" name="MONTANT_FACT_REPESEE" id="mt"  onchange="restfunc('mt0', 'mtdeja','mt', 'mp', 'mr', 'apt');"   placeholder=""  readonly="readonly" class="form-control" value="0"/>
                                                </td>
                                            </tr>
                             <!--               <tr class='clickable-row' data-href='detail_verbalisation.php? nfv=<?php //echo $re['ID_VERB'];  ?>' style="cursor: pointer;">      -->
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="MONTANT_A_PAYE" id="mp" onchange="restfunc('mt0', 'mtdeja','mt', 'mp', 'mr', 'apt');" required placeholder="" class="form-control" onkeyup="valid(this)" onblur="valid(this)" value="0"  />                                                       
                                                </td>
                                            </tr>                                                
                                            <tr>
                                                <td><label class="col-sm-10 control-label" for="form-field-5">
...
?>
  ...
  <!--             <a class="btn btn-green btn-lg" href="#receipt?MONTANT_A_PAYE=<script>document.forms['idformul'].elements['MONTANT_A_PAYE'].value;</script>" data-toggle = "modal"> <!--onClick="window.print()"--> 
    ...
    <script language="JavaScript" type="text/javascript">
        function restfunc(mt0,mtdeja,mt, mp, mr, apt)
        {
			var lemt0 = document.getElementById(mt0);
            var lemtdeja = document.getElementById(mtdeja);
			...
			var valeurlemt0 = lemt0.value;
            var valeurlempd = lemtdeja.value;
            var valeurlemt = lemt.value;
            var valeurlemp = lemp.value;
			lemt.value = valeurlemt0- valeurlempd;
