...
if ($_SESSION['first_connect'] != 1) {
    ...
    if (isset($_POST['search'])) {
        if (isset($_POST['dates'])) {
            ...
            $req = $conn->query("select  count([IMMAT_VEHICULE]) as Nbre_Camion_Encaisse,
                        sum(MONTANT_PAIEMENT) as Recette_logicielle, sum([AMENDE_TOTAL]) as Total_Amende_Verbalisation,
                        [MODE_REGLEMENT], count(*)*2000 as Frais_Pesee,
                        ( sum(MONTANT_PAIEMENT) - (count(*)*2000)) as Amende_Percue
                        FROM PAIEMENT, VERBALISATION WHERE 
                        verbalisation.ID_VERB=PAIEMENT.ID_VERB  
                        AND  DATE_PAIEMENT like '%$date_entry%' 
                        AND [TRAITE]='1'
        ...
        if (isset($_POST['dates2']) && isset($_POST['dates3'])) {
            ...
            $req = $conn->query("select  count([IMMAT_VEHICULE]) as Nbre_Camion_Encaisse,
                        ...
                        FROM PAIEMENT, VERBALISATION WHERE 
                        verbalisation.ID_VERB=PAIEMENT.ID_VERB  
                        AND  DATE_PAIEMENT BETWEEN '$date_entry2'  AND '$date_entry3' 
                        AND [TRAITE]='1'
        ...
        $req = $conn->query("select  count([IMMAT_VEHICULE]) as Nbre_Camion_Encaisse,
                        ...
                        FROM PAIEMENT, VERBALISATION WHERE 
                        verbalisation.ID_VERB=PAIEMENT.ID_VERB  
                        AND  DATE_PAIEMENT like '2017-02-01%' 
                        AND [TRAITE]='1'
    ...
    //DATE REQUEST ASC
    $dte2 = $conn->prepare("SELECT DISTINCT [DATE_PAIEMENT] FROM [Afriquepesage].[dbo].[PAIEMENT] ORDER BY [DATE_PAIEMENT] ASC");
    $dte2->execute();
            ...
            <div class="main-container">
                ...
                <div class="main-content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="page-header">
                                    <h1>
                                        REPORTING JOURNALIER <small>Responsable Caisse </small></h1>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="rc_report.php">
                                    <table width="100%" border="0">
                                        <tr>
                                            <td>
                                                <div align="center">
                                                    <h5><label style="color:#8C001A;font-weight:bold;">RECHERCHE PAR DATE:</label></h5>
                                                </div>
                                            </td>
                                            <td>
                                                <div align="center">
                                            ...
                                            <div class="col-md-12 space20">
                                                ...
                                                <div class="btn-group pull-right">
                                                    <li class="btn btn-purple dropdown-toggle" >
                                                        <a href="intro_responsable_caisse.php"  style="text-decoration:none;color: #ffffff;">
                                            ...
                                            <table class="table table-hover" id="sample-table-1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>NOMBRE DE CAMION ENCAISSE</th>
                                                        <th>RECETTE LOGICIELLE</th>
                                                        <th>FRAIS PESEE</th>
                                                        <th>AMENDE PERCUE</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    $nbre_camion = 0;
                                                    $recette_logicielle = 0;
                                                    $frais_pesee = 0;
                                                    $amende_percue = 0;
                                                    foreach ($result as $value) {
                                                        if (preg_replace('/\s+/', '', $value['MODE_REGLEMENT']) != "ESPECE") {
                                                            $nbre_camion = $nbre_camion + $value['Nbre_Camion_Encaisse'];
                                                            $recette_logicielle = $recette_logicielle + $value['Recette_logicielle'];
                                                            $frais_pesee = $frais_pesee + $value['Frais_Pesee'];
                                                            $amende_percue = $amende_percue + $value['Amende_Percue'];
                                                        } else {
                                                            ?>
                                                            <tr>
                                                                <td><?php
                                                                    if (isset($_POST['dates'])) {
                                                                        echo date_format(date_create($_POST['dates']), 'd-m-Y');
                                                                    } else {
                                                                        echo date("d-m-Y");
                                                                    }
                                                                    ?></td>
                                                                <td><?php echo $value['MODE_REGLEMENT']; ?></td>
                                                                <td><?php echo $value['Nbre_Camion_Encaisse']; ?></td>
                                                                <td><?php echo $value['Recette_logicielle']; ?></td>
                                                                <td><?php echo $value['Frais_Pesee']; ?></td>
                                                                <td><?php echo $value['Amende_Percue']; ?></td>
                                                            </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $nbre_camion; ?></td>
                                                        <td><?php echo $recette_logicielle; ?></td>
                                                        <td><?php echo $frais_pesee; ?></td>
                                                        <td><?php echo $amende_percue; ?></td>
                                                    </tr>
                                                    <tr style="color:red;font-weight: bold;font-size: 1.7em;">
                                                        <td>&nbsp;</td>
                                                        <td><?php echo "TOTAL"; ?></td>
                                                        <td><?php echo $nbre_camion + $value['Nbre_Camion_Encaisse']; ?></td>
                                                        <td><?php echo $recette_logicielle + $value['Recette_logicielle']; ?></td>
                                                        <td><?php echo $frais_pesee + $value['Frais_Pesee']; ?></td>
                                                        <td><?php echo $amende_percue + $value['Amende_Percue']; ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
