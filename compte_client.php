                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="page-header">
                                <h1>COMPTE CLIENT<small>Caissier(&egrave;re) </small></h1>
...
<!--                                                <tr class='clickable-row' data-href='detail_cpt_cl.php?cptcl=<?php //echo $sc['ID_COMPTE_CLIENT']; ?>' style="cursor: pointer;">-->
                                                <tr class='clickable-row' data-href='detail_cpt_cl_caiss.php?cptcl=<?php echo $sc['ID_COMPTE_CLIENT']; ?>' style="cursor: pointer;">
                                                        ...
                                                        <!--<td style="padding-top:2px;padding-bottom:2px;padding-left:2px"><a href='credit_cpt_cl_caiss.php?cptcli=<?php  //echo $sc['ID_COMPTE_CLIENT']; ?>'><img src='assets/images/crayon.png'/></img></a></td> -->   
                                                    </tr>   
                    ...
                    <div style="width:100px; margin: 0 auto;">
                     ...
                     <table style="float:right;">
                         <tr>
                             <td>
                                 <a href="intro_caissiere.php" class="btn btn-red btn-lg">Retour</a> 
                             </td>
                         </tr>
                     </table>
