...
and p."Numero_Pesee"= ' . $_SESSION['num_pesee'] . ' group by g."nom_GP" order by "high_gp" desc rows 1');
	...
	////if ($_SESSION['poid_total'] <= ($_SESSION['ptac'] * 120 / 100)) {
	//	if ($_SESSION['poid_total'] <= ($_SESSION['ptac'] )) {
	//    $fine = $fraisPESAGEINT;
	//}
												if ($_SESSION['poid_total'] <= ($_SESSION['ptac'] * 105 / 100)) {
													$fine = $fraisPESAGEINT;}
    ...
    //if (($_SESSION['poid_total'] > ($_SESSION['ptac'] ))) {
		////$surcharge = $_SESSION['poid_total'] - ($_SESSION['ptac'] * 120 / 100);
	  //$surcharge = $_SESSION['poid_total'] - ($_SESSION['ptac'] );
     //      $_SESSION['value_surcharge'] = $surcharge;
    //      $fine = ($surcharge * $frais_ext_INT01) + $fraisPESAGEINT;
   //   }												
												else
												if (($_SESSION['poid_total'] > ($_SESSION['ptac'] * 105 / 100))) {
													$surcharge = $_SESSION['poid_total'] - ($_SESSION['ptac'] * 105 / 100);
                                                    $_SESSION['value_surcharge'] = $surcharge;
                                        ...
                                        //IV-THE TRANSPORT IS NEITHER HYDROCARBURE OR GRUME NOR SET TO GLOBAL WEIGHT SO LOGIC GOES AS NORMAL AS USUAL
                                            ...
                                            //IV-3 CHECK IF TRANSPORT IS NATIONAL
                                                ...
                                                if ($_SESSION['value_extreme_surcharge'] > 0) {
                                                    $fine = ($_SESSION['value_extreme_surcharge'] * $AmendeExtremeSurNat) + ($pds * $INFPoidsTotalsAmNAT) + $fraisPESAGENAT;
                                                } else {
                                        ...
                                        <div id="two">
                                            ...
                                            <table width="100%" border="1" style=" margin-top:0.5%">
                                                <tr>
                                                    ...
                                                    <th scope="col">POIDS UEMOA(KG)</th>
                                            ...
                                            <table width="100%" border="1" style=" margin-top:0.5%">
                                                ...
                                                <tr>
                                                    ...
                                                    if ($_SESSION['value_surcharge'] == 0 && $pds == 0) {
                                                        ...
                                                        <?php
                                                    } else if ($_SESSION['value_surcharge'] != 0 && $_SESSION['poids_total_extreme_surcharge'] == 0) {
                                                        ?>
                                                        <td>
                                                            SURCHARGE TAXABLE AU "<?php
                                                        ...
                                                        <td>
                                                            SURCHARGE TAXABLE AU "<?php
                                                            $_SESSION['overload_name'] = $_SESSION['overload_name'] . " A L'EXTREME SURCHARGE";
                                                            echo $_SESSION['overload_name'];
                                                            ?>"
                                                        </td>
                                                        <td align="right">
                        ...
                        <table class="table table-hover table-bordered" id="sample-table-1">
                            ...
                            <tbody style=" text-align: center;">
                                <tr>
                                    ...
                                    <td>
                                        <?php
										if ($_SESSION['transport'] == "NATIONAL"){
											$_SESSION['value_surcharge'] = $result_P['surcharge_Vehicule_Pesee']-0.2*$_SESSION['ptac'];
											if ($_SESSION['value_surcharge']<=0)
											{
												$_SESSION['value_surcharge']=0;
												echo $_SESSION['value_surcharge'];
											}
											else{
												echo $_SESSION['value_surcharge'];
											}
											...
											$_SESSION['value_surcharge'] = $result_P['surcharge_Vehicule_Pesee']-0.05*$_SESSION['ptac'];
											if ($_SESSION['value_surcharge']<=0)
											{
												$_SESSION['value_surcharge']=0;
												echo $_SESSION['value_surcharge'];
                                ...
                                <table width="100%" border="1" style=" margin-top:0.5%">
                                    ...
                                    <tr>
                                        ...
                                        if ($_SESSION['value_surcharge'] == 0 && $pds == 0) {
                                            ...
                                            ?>
                                            <td>
                                                SURCHARGE TAXABLE AU "<?php echo $_SESSION['overload_name']; ?>"
                                            </td>
                                            <?php
                                        }
                                        ?>
