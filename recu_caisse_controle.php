...
$mtdejaencaisse = $_POST['MONTANT_DEJA_ENCAISSE'];
$mtafactrepesee = $_POST['MONTANT_FACT_REPESEE'];

$mttapaye = $_POST['MONTANT_A_PAYE'];
$mttrest = $_POST['MONTANT_RESTANT'];
$modregl = $_POST['MODE_REGLEMENT'];

$_SESSION['MDENCAISSE'] = $mtdejaencaisse;
$_SESSION['MREPESEE'] = $mtafactrepesee;
...
if ($mttapaye <= 0) {
    ...
    echo"<script>
                   ...
                   window.location.href = 'fiche_verbalisation_controle.php';
                 </script>";
}
   ...
   // echo " B " . $reqest['ID_COMPTE_CLIENT'];
    ...
    if (empty($reqest['ID_COMPTE_CLIENT'])) {
        ...
        echo" <script>
					 ...
					 window.location.href = 'detail_verbalisation_controle.php';
				  </script>";
   ...
   <body class="page-full-width">
        ...
        <div align="center">
            <div class="modal-body" id ="printThis">
                ...
                <div class="row">
                    <section style="width:100%; margin:0  ;font-size: 20.8px; background-repeat:no-repeat;">
                        <div id="two" style="width:555px;">
<?php //echo date("d/m/y")."<br>".$dat_pai."<br>".$datverb; ?>
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td><div align="left"><?php echo  substr($lesite,0,18); ?>  </div>
                                    </td></tr> 
                                   <tr>  <td><div align="left"><b>
                                                EXPORTATEUR :  
                                            </b></div></td>
                                    <td><div   align="left"><?php echo substr($client,0,18); ?>  </div>
                                    </td>
                                </tr>       
                                <td><div align="left"><b>     
                                            VERBALISATION : 
                                        </b></div></td>
                                <td><div align="left"><?php echo $verb; ?></div></td> </tr> 
                                <tr> <td><div align="left"><b>
                                            CLIENT : 
                                        </b></div></td>
                                <td><div align="left" ><?php echo $scte ?></div></td>
                                </tr>
                                <tr>
                                    <td><div align="left"><b>
                                                DATE : 
                                            </b></div></td>
                                    <td><div align="left"> <?php echo date("d/m/Y") ?></div></td></tr> 
                                  <tr>   <td><div align="left"><b> 
                                                IMMATRICULATION: 
                                            </b></div></td>
                                    <td><div align="left"><?php echo substr($imat,0,21); ?></div></td>
                                ...
                                <tr>
                                    ...
                                    <td><div align="left"><?php echo $numpese; ?> </div></td> </tr>                                                                                  
                                   <tr>  <td><div align="left"><b> TRAFIC : </b></div></td>
                                    <td><div align="left"> <?php echo  substr($provdest,0,19); ?></div></td> 
                                </tr>
                                <tr>
                            ...
                            <table width="100%" border="1" >
                                <tr>
                                    ...
                                    <th scope="col"><div align="left">AMENDE(S)</div></th>
                                </tr>
                                <tr>
<?php
...
?>
                            ...
                            <table width="100%" border="0" >
                                <tr>
                                    <td><b><div align="left">MODE DE PAIEMENT :</div></b></td>
                                    <td><div align="left"><?php echo $_SESSION['MODE_RGLMNT']; ?></div> </tr>
                                   <tr> <td><b><div align="left">AMENDE TOTALE:</div></b></td>
                                    <td><div align="rignt"><?php echo number_format($amdetot, 0, '', '.') . " " . $devise; ?></div></td></tr>
									<tr><td><b><div align="left">AMENDE REPESEE :</div></b></td>
                                    <td><div align="rignt"><?php echo number_format($mtafactrepesee, 0, '', '.') . " " . $devise; ?></div></td></tr>
                                <tr></td><td><b><div align="left">MONTANT VERSE :</div></b></td>
                            <td><div align="left"><?php echo number_format($mttapaye, 0, '', '.') . " " . $devise; ?></div></td>    </tr>
                    ...
                    <table width="100%" border="0" style="margin-top:3%"> 
                        <tr>
...
<?php ?>
    ...
    <div class="modal-footer">
        ...
        <a class="btn btn-red btn-lg" href="fiche_verbalisation_controle.php">
            ANNULER
