...
DATE_VERB AS DATE_HEURE, SUBSTRING(DATE_VERB, 4, 10) AS CAMPAGNE, ID_VERB AS Num_VERBALISATION, NUM_PESEE_WIM as NUM_PESE, CLASSE_VEHICULE as TYPE_VEHICULE,
NOM_CLIENT as SOCIETE, IMMAT_VEHICULE as IMMATRICULATION, PROV_DEST as PROV_DEST, PRODUIT_TRANSPORTE as PRODUIT,
AMENDE_TOTAL as AMENDE, NATIONALITE as NATIONALITE
FROM VERBALISATION where [DATE_VERB] ='$date_entry' AND [NOM_STE] = '$nom_site' order by CAST(NUM_PESEE_WIM as int)");
            $req2 = $req;
            $req->execute();
            $result = $req->fetchAll();
...
NOM_CLIENT as SOCIETE, IMMAT_VEHICULE as IMMATRICULATION, PROV_DEST as PROV_DEST, PRODUIT_TRANSPORTE as PRODUIT,
AMENDE_TOTAL as AMENDE, NATIONALITE as NATIONALITE
FROM VERBALISATION where AMENDE_TOTAL >= 0  AND [DATE_VERB] BETWEEN '$date_entry2' and '$date_entry3'
...
NOM_CLIENT as SOCIETE, IMMAT_VEHICULE as IMMATRICULATION, PROV_DEST as PROV_DEST, PRODUIT_TRANSPORTE as PRODUIT,
AMENDE_TOTAL as AMENDE, NATIONALITE as NATIONALITE
FROM VERBALISATION WHERE [DATE_VERB] like '$dte' AND [NOM_STE]= '$nom_site' order by CAST(NUM_PESEE_WIM as int)");
            ...
            <div class="main-container">
                ...
                <div class="main-content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="rapport_verbalisation.php">
