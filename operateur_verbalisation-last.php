    ...
    <html lang="en" class="no-js">
        ...
        <body class="page-full-width">  
            ...
            if (!isset($_SESSION['num_pesee'])) {
                 ...
                 */
                $photo_vehicule_info = $conn->query("SELECT [silhouette]  FROM [Afriquepesage].[dbo].[PARAM_SURCH] WHERE [Type_vehicule]='$photo_vehicule_link'");
                 ...
                 */
                $grpe_ess_info = $dbh->query('SELECT a."id_GP", a."id_MP", a."nom_GP", a."poidsMax_GP", a."nbrEssieux_GP", a."image_GP", a."poids_GP", a."distMinGroupe_GP", a."distMaxGroupe_GP", a."distGroupeMesure_GP", a."position_GP", a."erreur_GP", a.RDB$DB_KEY FROM "Group_Pese" a,"Mobile_Pese" b, "Vehicule_Pese" c, "Pesee" d where c."id_VP"=d."Id_VP" and c."id_VP"=b."id_VP" and b."id_MP"=a."id_MP" and d."Numero_Pesee"=' . $_SESSION['num_pesee']);
                $grpe_ess_info->execute();
                $grpe_ess = $grpe_ess_info->fetchAll();
                /*
                ...
                //GET THE TYPE OF WEIGHTING PROCESS
                $nbreInf = "SELECT [CODE_TYPE_INF],[LIBELLE_TYPE_INF],[MONTANT_INF_INT],[MONTANT_INF_NAT] FROM [dbo].[TYPE_INFRACTION]";
                $nbreinfra = $conn->query($nbreInf);
                $totinf = $nbreinfra->fetchAll();
            }
                ...
                <form method="post" action="">
                    ...
                    <div class="main-content">
                        <div class="container">
                            ...
                            $_SESSION['poid_total'] = $result_P['poids_total_vehicule_Pesee'];
                                    ...
                                    <table class="table table-hover table-bordered" id="sample-table-1">
                                        ...
                                        <tbody style=" text-align: center;">
                                            <tr>
                                                ...
                                                <?php
                                                $val_ext_sur = $result_P['poids_total_vehicule_Pesee'] - $uemoa['seuil_ext_surc'];
                                                ?>
                                                <td style="color:<?php switchColor($val_ext_sur) ?>; font-size:<?php switchFont($val_ext_sur) ?>">
                                                    <?php
                                                    if ($val_ext_sur < 0) {
                                                        $_SESSION['value_extreme_surcharge'] = 0;
                                                        echo 0;
                                                    } else {
                                                        $_SESSION['value_extreme_surcharge'] = $val_ext_sur;
                                                        echo $val_ext_sur;
                                                    }
                                                    ?>
                                                </td>
                                                <td style="color:<?php color($val_ext_sur) ?>; font-size:<?php font($val_ext_sur) ?>">
                                                    <?php
                                                    if ($val_ext_sur < 0) {
                                                        $_SESSION['value_surcharge'] = $result_P['surcharge_Vehicule_Pesee'];
                                                        echo $result_P['surcharge_Vehicule_Pesee'];
                                                    } else {
                                                        $val_sur = abs($val_ext_sur - $result_P['surcharge_Vehicule_Pesee']);
                                                        $_SESSION['value_surcharge'] = $val_sur;
                                                        echo $val_sur;
                                                    }
                                                    ?>
                                                </td>
                                            ...
                                            <div class="form-group">
                                                <table width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>                                                        
                                                            <input id="form-field-1" class="form-control" name="transport" type="text" value="<?php echo $_SESSION['transport'] ?>" placeholder=""  readonly />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
...
and p."Numero_Pesee"= ' . $_SESSION['num_pesee'] . ' group by g."nom_GP" order by "high_gp" desc rows 1');
                                        ...
                                        //III-THE TRANSPORT IS SET TO GLOBAL WEIGHT
                                            ...
                                            if ($_SESSION['transport'] == "INTERNATIONAL") {
                                                ...
                                                if ($_SESSION['value_extreme_surcharge'] > 0) {
                                                    $fine = ($_SESSION['value_extreme_surcharge'] * 60) + ($pds * $INFPoidsTotalsAmINT) + $fraisPESAGEINT;
                                                } else {
                                            ...
                                            //III-3 CHECK IF TRANSPORT IS NATIONAL
                                                ...
                                                if ($_SESSION['value_extreme_surcharge'] > 0) {
                                                    $fine = ($_SESSION['value_extreme_surcharge'] * 20) + ($pds * $INFPoidsTotalsAmNAT) + $fraisPESAGENAT;
                                                } else {
                                            ...
                                            //III-3 THE TRANSPORT IS THEN PREFERENTIAL
                                            else {
                                                if ($_SESSION['value_extreme_surcharge'] > 0) {
                                                    $fine = ($_SESSION['value_extreme_surcharge'] * 20) + ($pds * $INFPoidsTotalsAmNAT) + $fraisPESAGENAT;
                                                } else {
                                        ...
                                        //IV-THE TRANSPORT IS NEITHER HYDROCARBURE OR GRUME NOR SET TO GLOBAL WEIGHT SO LOGIC GOES AS NORMAL AS USUAL
                                            ...
                                            //IV-1 CHECK WHICH IS BIGGER AMONG ESSIEUXX GROUP ESSIEUX AND POIDS VEHICULE
                                        ...
                                        $var = substr($_SESSION['montant_a_paye'], -3);
                                        //echo $var;
                                        ...
                                        <table width="100%" border="0">
                                            <tr>
                                                ...
                                                /* $bills = $_SESSION['montant_a_paye'];
                                                  ...
                                                  $exportateur = $conn->prepare("SELECT * FROM [Afriquepesage].[dbo].[COMPTE_CLIENT] WHERE [SOCIETE]= '$_c' AND [SOLDE_COMPTE_CLIENT] > '$bills'");
                                                  $exportateur->execute();
                                        ...
                                        <div id="two">
                                            <table width="100%" border="0">
                                                <tr>
                                                    <td colspan="5">
                                                        <div align="center">
                                                            R&Eacute;PUBLIQUE DE C&Ocirc;TE D'IVOIRE - MINIST&Egrave;RE DES INFRASTRUCTURES
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="5">
                                                        <div align="center">
                                                            STATION DE PESAGE FIXE <?php echo $_SESSION['site']; ?>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr >
                                                ...
                                                <tr>
                                                    <td>
                                                        <div align="left">
                                                             <b>
                                                    Nº VERBALISATION : <?php echo $_SESSION['num_verb']; ?>
                                                </b> <br><br>
                                                <b>
                                                    Nº PES&Eacute;E : <?php echo $_SESSION['num_pesee_webafp']; ?> 
                                                </b>
                                                        </div>
                                                    </td>
                                                    <td><div align="left" ><?php echo $_SESSION['num_verb']; ?></div></td>
                                                    <td><div align="left"><b>DATE : </b></div></td>
                                                    <td>
                                                        <div align="left"><?php echo date('d-m-Y H:i:s'); ?> </div></td>
                                                    <td>
                                                        <div align="center">
                                                            <?php
                                                            echo '<img src="qr_code.php" style="width:120px;"/>';
                                                            ?>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><div align="left"><?php echo $_SESSION['num_pesee_webafp']; ?> </div></td>
                                                    <td><div align="left">
                                                            <b>
                                                                PROV/DEST
                                                            </b>
                                                        </div></td>
                                                    <td><div align="left"><?php echo $provenance['valeur_champs']; ?>
                                                        </div></td>
                                                    <td>
                                                        <div align="center">
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div align="left"><?php echo $societe['valeur_champs']; ?>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div align="left">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center">
                                                        ...
                                                        if ($val_ext_sur < 0) {
                                                            ...
                                                            $_SESSION['poids_total_extreme_surcharge'] = $val_ext_sur;
                                                            echo $val_ext_sur;
                                                        }
                                                        ?>
                                                    </td>
                                            ...
                                            <table width="100%" border="1" style=" margin-top:0.5%">
                                                ...
                                                <tr>
                                                    ...
                                                    if ($_SESSION['value_surcharge'] == 0 && $pds == 0) {
                                                        ...
                                                        ?>
                                                        <td>
                                                            FACTURATION FAITE SUR "<?php
                                                            $_SESSION['overload_name'] = $_SESSION['overload_name'] . " ET L'EXTREME SURCHARGE";
                                                    ...
                                                    <td align="right">
                                                        <?php
                                                        $_SESSION['overload_mass'] = $_SESSION['overload_mass'] + $_SESSION['poids_total_extreme_surcharge'];
                                                        echo $_SESSION['overload_mass'] . " KG";
                                                        ?>
                                                    </td>
                                                    <td align="right">
                                                        <?php
        ...
        <div id="receipt" class="modal fade" tabindex="-1" data-width="700">
            <form method="post" action="">
                <div class="modal-body" id ="printThis">
                    ...
                    <div class="row" >
                        <section   style="width:100%; margin:0 auto;font-size: 11px; background-image:url(assets/images/modal.png); background-repeat:no-repeat;">
                            <img src="assets/images/modalhead.png" id="overlay">
                            <div id="two">
                                <table width="100%" border="0">
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div align="left" >
                                                ...
                                                <b>
                                                    SOCI&Eacute;T&Eacute;/PROP : <?php echo $societe['valeur_champs']; ?>
                                                </b><br><br>
                                                <b>
                                                    IMMATRICULATION :  <?php
                                                $_SESSION['immatriculation'] = $immatriculation['valeur_champs'];
                                        ...
                                        <td>
                                            <div align="left" >
                                                <b>DATE : <?php echo date('d-m-Y H:i:s'); ?> </b>
                                                <br><br>
                                                <b>
                                                    PROV/DEST: <?php echo $provenance['valeur_champs']; ?>
                                                </b><br><br>
                                                <b>EXPORTATEUR: <?php echo $_SESSION['exportateur']; ?></b><br><br>
                                                 <b>
                                                    NATIONALIT&Eacute; : <?php echo $_SESSION['nationalite']; ?>
                                                </b>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div align="left" >
                                                <b>
                                                    PRODUIT :   <?php echo $produit['valeur_champs']; ?>
                                                </b>
                                        ...
                                        <td>
                                            <div align="left" >
                                                <strong>
                                                    TRANSPORT : <?php echo $_SESSION['transport']; ?>
                                                </strong>
                                            </div>
                                        </td>
                                        <td>
                                ...
                                <table width="100%" border="1" style=" margin-top:0.5%">
                                    ...
                                    <tr>
                                        ...
                                        if ($_SESSION['value_surcharge'] == 0 && $pds == 0) {
                                            ...
                                            ?>
                                            <td>
                                                FACTURATION FAITE SUR "<?php echo $_SESSION['overload_name']; ?>"
                                            </td>
                                            <?php
                                        }
                                        ?>
                                        <td align="right">
                                            <?php echo $_SESSION['overload_mass'] . " KG"; ?>
                                        </td>
                                        <td align="right">
                                            <?php
                                            if ($_SESSION['transport'] == "INTERNATIONAL") {
