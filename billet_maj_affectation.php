...
//Infos Caissier
                ...
                $totdef = $nbrut->fetch();
//Infos caisses
                $rc="SELECT [LIBELLE_CAISSE] FROM [Afriquepesage].[dbo].[CAISSE] WHERE [ID_CAISSE]='".$id_c."'";
                $rc1=$conn->query($rc);
                $csse=$rc1->fetch();
//utilisateur ayant ouvert la session
 ...
 // Affectation
                    $rqaf="SELECT [DATE_AFFECTATION],[MONTANT_POURVU] FROM [Afriquepesage].[dbo].[AFFECTER] WHERE [ID_SESSION]='".$id_s."' AND [ID_CAISSE]='".$id_c."' AND [ID_USER]='".$id_ut."'";
...
<html lang="fr" class="no-js">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="page-header">
                                <h1>
                                    RESPONSABLE CAISSE <small>Impression Billet ouverture caisse </small></h1>
  ...
  <table width="700" border="1" class="table table-striped table-bordered table-hover table-full-width">
    ...
    <tr>
      <th scope="col" style="text-align: center;">BILLET D'OUVERTURE DE CAISSE (modifié)</th>
    </tr>
    <tr>
    <td>
    <strong>SESSION OUVERTE PAR:</strong><?php echo $usersession['NOM_UT'].''.$usersession['PRENOM_UT']; ?> <br/><br/>
   ...
   <strong> MONTANT POURVU :</strong><?php echo $infossession['MONTANT_POURVU']; ?> <br/><br/>
    ...
    <strong>HEURE OUVERTURE:</strong><?php echo date("H:i:s");?><br/>
    </td>
    </tr>
