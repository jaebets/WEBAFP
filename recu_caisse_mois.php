...
if ($mttapaye <= 0) {
    ...
    echo"<script>
                   ...
                   window.location.href = 'fiche_verbalisation_mois.php';
                 </script>";
}
   ...
   // echo " B " . $reqest['ID_COMPTE_CLIENT'];
    ...
    if (empty($reqest['ID_COMPTE_CLIENT'])) {
        ...
        echo" <script>
					 ...
					 window.location.href = 'detail_verbalisation_mois.php';
				  </script>";
    ...
    <body class="page-full-width">
        ...
        <div align="center">
            <div class="modal-body" id ="printThis">
                ...
                <div class="row">
                    <section style="width:100%; margin:0  ;font-size: 21px; background-repeat:no-repeat;">
                        <div id="two" style="width:500px;">
<?php //echo date("d/m/y")."<br>".$dat_pai."<br>".$datverb; ?>
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td><div align="left"><?php echo $lesite; ?>  </div>
                                    </td></tr> 
                                   <tr>  <td><div align="left"><b>
                                                EXPORTATEUR :  
                                            </b></div></td>
                                    <td><div align="left"><?php echo $client; ?>  </div>
                                    </td>
                                </tr>       
                                <td><div align="left"><b>     
                                            VERBALISATION : 
...
<?php ?>
    ...
    <div class="modal-footer">
        ...
        <a class="btn btn-red btn-lg" href="fiche_verbalisation_mois.php">
            ANNULER
