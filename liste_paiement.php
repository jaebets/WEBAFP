...
if ($_SESSION['first_connect'] != 1) {
    ...
    if (isset($_POST['search'])) {
        if (isset($_POST['dates'])) {
            ...
            $req = $conn->query(" SELECT [ID_PAIEMENT],[ID_VERB],u.NOM_UT, u.PRENOM_UT,[MONTANT_PAIEMENT],[MODE_REGLEMENT],[DATE_PAIEMENT],LEFT([HEURE_PAIEMENT],8) as [HEURE_PAIEMENT],
			                       [DATE_VERBL],[NUM_PSEE],[ID_CAISSE],[ID_SESSION]FROM [Afriquepesage].[dbo].[PAIEMENT] as P, [Afriquepesage].[dbo].[UTILISATEUR] as U 
								   where p.ID_USER =u.ID_USER and [DATE_PAIEMENT]= '$date_entry' ORDER BY [DATE_PAIEMENT],HEURE_PAIEMENT DESC");
            $req->execute();
            $result = $req->fetchAll();
        } else {
        ...
        if (isset($_POST['dates2']) && isset($_POST['dates3'])) {
            ...
            $req = $conn->query(" SELECT [ID_PAIEMENT],[ID_VERB],u.NOM_UT, u.PRENOM_UT,[MONTANT_PAIEMENT],[MODE_REGLEMENT],[DATE_PAIEMENT],LEFT([HEURE_PAIEMENT],8) as [HEURE_PAIEMENT],
			[DATE_VERBL],[NUM_PSEE],[ID_CAISSE],[ID_SESSION] FROM [Afriquepesage].[dbo].[PAIEMENT] as P, [Afriquepesage].[dbo].[UTILISATEUR] as U 
			where p.ID_USER =u.ID_USER and [DATE_PAIEMENT] between '$date_entry2' and '$date_entry3' ORDER BY [DATE_PAIEMENT],HEURE_PAIEMENT DESC ");
            $req->execute();
            $result = $req->fetchAll();
        } else {
        ...
        $req = $conn->query("SELECT [ID_PAIEMENT],[ID_VERB],u.NOM_UT, u.PRENOM_UT,[MONTANT_PAIEMENT],[MODE_REGLEMENT],[DATE_PAIEMENT],LEFT([HEURE_PAIEMENT],8) as [HEURE_PAIEMENT],
			                       [DATE_VERBL],[NUM_PSEE],[ID_CAISSE],[ID_SESSION]FROM [Afriquepesage].[dbo].[PAIEMENT] as P, [Afriquepesage].[dbo].[UTILISATEUR] as U 
								   where p.ID_USER =u.ID_USER and [DATE_PAIEMENT]= '$dte ' ORDER BY [DATE_PAIEMENT],HEURE_PAIEMENT DESC");
            ...
            <div class="main-container">
                ...
                <div class="main-content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="page-header">
                                    <h1>
                                        PAIEMENTS <small>Responsable Site </small></h1>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="liste_paiement.php">
                                            ...
                                            <table class="table table-hover" id="sample-table-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($result as $value) {
                                                        $somme = $somme + $value['MONTANT_PAIEMENT'];
                                                        $compte = $compte + 1;
                                                        ?>
                                                        <tr>
                                                            <td><?php echo substr((date_format(date_create($value['DATE_PAIEMENT']), 'd-m-Y') . " " . $value['HEURE_PAIEMENT']), 0, 19); ?></td>
                                                            <td><?php echo $value['ID_PAIEMENT']; ?></td>
                                                            <td><?php echo $value['ID_VERB']; ?></td>
                                                            <td><?php echo number_format($value['MONTANT_PAIEMENT'], 0, '', ' ') . " " . $devise; ?></td>
                                                            <td><?php echo $value['MODE_REGLEMENT']; ?></td>
                                                            <td><?php echo $value['NUM_PSEE']; ?></td>
                                                            <td><?php echo $value['NOM_UT'] . " " . $value['PRENOM_UT']; ?></td>
                                                            <td><?php echo $value['ID_SESSION']; ?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
                                                    *NOMBRE PAIEMENTS:<?php echo $compte; ?><br/><br/>*TOTAL PAIEMENTS:<?php echo number_format($somme, 0, '', ' ') . " " . $devise; ?><br/><br/>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
