                                        ...
                                        <ul class="dropdown-menu" style="width: -2px;">
                                            <li>
                                                <a href="#"><i class="clip-home-2"></i>
                                                    &nbsp;Site: <?php echo $_SESSION['site']; //$_SESSION['login_utilisateur']; ?>
                                                </a>
                                            </li>
                                            <li>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <form method="post" action="ouverture_caisse.php">
                                                <button class="btn btn-icon btn-block">
                                                    <i class="fa fa-shopping-cart "></i>
                                                    Session caisse <span class="badge badge-danger"> <i class="fa fa-shopping-cart "></i> </span>
                                                </button>
                                            </form> 
                                        </div>
                                        <div class="col-sm-2">
                                            <form method="post" action="etat_verba.php">
                                                <button class="btn btn-icon btn-block">
                                                    ...
                                                    Etat des verbalisations <span class="badge badge-danger"> <i class="fa fa-bar-chart-o "></i> </span>
                                                </button>
                                            </form>
                                        </div>
                                        <div class="col-sm-2">
                                            <form method="post" action="saisie_cptclient.php">
                                                <button class="btn btn-icon btn-block">
                                        ...
                                        <div class="col-sm-2">
                                            <form method="post" action="journalcaisse.php">
                                                <button class="btn btn-icon btn-block">
                                                    <i class="fa fa-credit-card "></i>
                                                    Etat Journalier de caisse <span class="badge badge-danger"> <i class="fa fa-credit-card "></i> </span>
                                                </button>
                                            </form>
                                        </div>
                                        <div class="col-sm-2">
                                            <form method="post" action="bilan_session_caisse.php">
                                                <button class="btn btn-icon btn-block">
                                                    <i class="fa fa-credit-card "></i>
                                                    Bilan des Sessions de caisse<span class="badge badge-danger"> <i class="fa fa-credit-card "></i> </span>
                                                </button>
                                            </form>
                                        </div>
                                        <div class="col-sm-2">
                                            <form method="post" action="reporting_paiement.php">
                                                <button class="btn btn-icon btn-block" >
                                                    ...
                                                    Reporting <span class="badge badge-danger"> <i class="fa fa-book"></i> </span>
                                                </button>
                                            </form>
                                        </div>
										
										<div class="col-sm-2">
                                            <form method="post" action="fiche_verbalisation.php">
                                                <button class="btn btn-icon btn-block">
                                                    <i class="fa fa-shopping-cart "></i>
										...
										<div class="col-sm-2">
                                            <form method="post" action="fiche_verbalisation_all.php">
                                                <button class="btn btn-icon btn-block">
                                                    <i class="fa fa-shopping-cart "></i>
                            ...
                            <div class="btn-group pull-right">
                                <li class="btn btn-red dropdown-toggle" >
                                    <a href="intro_respo_caisse.php"  style="text-decoration:none;color: #ffffff;">
