                    ...
                    <div class="panel-body">
                        <?php
                            ...
                            $info = $conn->query("SELECT [ID_VERB],[ID_USER],[NUMERO_PESE],[DATE_VERB],LEFT([HEURE_VERBALISATION],8) AS HEURE_VERBALISATION,[NATIONALITE],[TRANSIT],[PDPUIT_DANGE],[INF_GABARIT],[LOGIN_OP],[AMENDE_TOTAL],[EXPORTATEUR]
                                                  ...
                                                  FROM [Afriquepesage].[dbo].[VERBALISATION]  WHERE [TRAITE] = 0 and  [TYPE_VERBALISATION] ='VERBALISATION DE CONTROLE' and [NOM_STE] = '$nomsite'  order by [Afriquepesage].[dbo].[VERBALISATION].[NUM_PESEE_WIM] desc");
			     ...
			     $info->execute();
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                            ...
                            <!--     <tr class='clickable-row' data-href='operateur_verbalisaion33.php? nfv=<?php // echo $re['ID_VERB']; ?>' style="cursor: pointer;">  -->
                                <tr class='clickable-row' data-href='detail_verbalisation_controle.php?nfv=<?php echo $re['ID_VERB']; ?>' style="cursor: pointer;">  
