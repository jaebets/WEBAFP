...
$request = "SELECT * FROM [dbo].[VERBALISATION] WHERE [NUMERO_PESE]='$nv'";
$status_info = $conn->prepare($request);
$status_info->execute();
$status = $status_info->fetch();
$id_verbs = $status['ID_VERB'];
$check_pesee = preg_replace('/\s+/', '', $status['NUM_PESEE_WIM']);

//GET THE  INFRACTION VERBALIZATION INFO FROM MSSQL
$req = "SELECT * FROM [dbo].[VERBALISATION_INFRACTION] WHERE [ID_VERB]='$id_verbs'";
                    ...
                    <div class="container">
                        ...
                        <div class="row " style="margin-top: 0.5%; border-bottom: 2px solid #8C001A;">
                                    ...
                                    <div class="form-group">
                                        <table width="100%" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="form-field-1" class="form-control" value="<?php echo date_format(date_create($status['DATE_VERB']), 'd/m/Y'); ?>" type="text" placeholder="" readonly ></td>
                                            </tr>
                                            <tr>
                                                <td><label class="col-sm-12 control-label" for="form-field-5">
                                                        OP&Eacute;RATEUR
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <table width="100%" border="0">
                                            ...
                                            <tr>
                                                <td><label class="col-sm-12 control-label" for="form-field-5">
                                                        PROPRI&Eacute;TAIRE DU VEHICULE
                                                    </label></td>
                                    ...
                                    <div class="form-group">
                                        <table width="100%" border="0">
                                            <tr>
                                                ...
                                                <td>                                                        
                                                    <input id="form-field-1" class="form-control" name="transport" type="text" value="<?php if (preg_replace('/\s+/', '', $status['TRANSIT']) != "PREFERENTIEL") {
                                                               echo preg_replace('/\s+/', '', $status['TRANSIT']);
                                                           } else {
                                                               echo "INTERNATIONAL";
                            ...
                            <div class="col-sm-2">
                                ...
                                <span style="border-style:none;color: #8C001A;"> <?php if ($status['PDPUIT_DANGE'] != '') {
                                                               echo $status['PDPUIT_DANGE'];
                                                           } else {
                                                               
                                                           } ?></span>
														   
			                    <span style="border-style:none;color: #8C001A;"> <?php if ($status['TYPE_VERBALISATION'] != '') {
                                                               echo $status['TYPE_VERBALISATION'];
                                                           } else {
...
<?php echo $status['NATIONALITE']; ?>
                                                                ...
                                                                <b>
                                                                    ...
                                                                    <?php if (preg_replace('/\s+/', '', $status['TRANSIT']) != "PREFERENTIEL") {
                                                                        echo preg_replace('/\s+/', '', $status['TRANSIT']);
                                                                    } else {
                                                                        echo "INTERNATIONAL";
                                                                    } ?>
...
?>
                                                        ...
                                                        <td>
                                                            <div align="right">
                                                                <?php echo $status['OVERLOAD_MASS'] . " KG"; ?>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div align="right">
...
?>
                                                ...
                                                <table width="100%" border="0" style=" margin-top:2%">
                                                    <tr>
                                                        ...
                                                        <td><span style="border-style:none;color: #8C001A;"> <?php if ($status['PDPUIT_DANGE'] != '') {
    echo $status['PDPUIT_DANGE'];
} else {
    
} ?></span></td>

<td><span style="border-style:none;color: #8C001A;"> <?php if ($status['TYPE_VERBALISATION'] != '') {
    echo $status['TYPE_VERBALISATION'];
} else {
