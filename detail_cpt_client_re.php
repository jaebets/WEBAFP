...
if (isset($_POST['research'])) {
    if (isset($_POST['dates2']) && isset($_POST['dates3'])) {
        ...
        $dettable = "SELECT p.[ID_PAIEMENT] ,p.[ID_CLIENT],p.[ID_USER],p.[ID_VERB],p.[MONTANT_PAIEMENT],p.[MODE_REGLEMENT],p.[DATE_PAIEMENT],p.[OBSERVATION_PAIEMENT],p.[DATE_VERBL],p.[NUM_PSEE],p.[LOGIN_UT],p.[ID_CAISSE],p.[ID_SESSION],v.[IMMAT_VEHICULE],v.[ID_VERB]
...
<html lang="fr" class="no-js">
                ...
                <div class="container">
                    ...
                    <div id="imp" class="row " style="margin-top: 2.5%; border-bottom: 2px solid #8C001A;">
                        ...
                        <table width="100%" border="0">
                            <tr>
                            <form method="post" action="detail_cpt_client_re.php">
                                <td>
                                    <div align="center">
  ...
  <!--                 <input type="submit" class="btn btn-green btn-lg" value="IMPRIMER"/>    
                    ...
                    <a class="btn btn-red btn-lg" href="compte_client_re.php">
                        RETOUR
