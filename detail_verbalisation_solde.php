...
if (isset($_POST['ENREGISTRER'])) {
 ...
 $_SESSION['idverba'] = $_POST['duplicata_sld'];
   ...
   $_SESSION['NOM_SOCIETE']  = $retrieve['NOM_STE'];
   ...
   $_SESSION['AMENDE_TOTAL'] = $retrieve['AMENDE_TOTAL'];
    $_SESSION['MONTANT_A_PAYE']  = $retrieve['MONTANT_AMENDE_PAYE'];
   $_SESSION['MONTANT_RESTANT']  = $retrieve['MONTANT_RESTANT'];
//   $_SESSION['MODE_REGLEMENT'] = $_POST['MODE_REGLEMENT'];
      // echo $_SESSION['AMENDE_TOTAL']." ".$mtt;     [MONTANT_AMENDE_PAYE],[MONTANT_RESTANT]

  //         echo 'Mode reglmnt : '.$_POST['MODE_REGLEMENT'].' Montant à solder : '.$_POST['MONTANT_SOLDE'].' Montant restant : '.$_POST['MONTANT_A_PAYE'].' Montant total : '.$mtttot;
...
/// récuperation de la devise parametrée pour les affichages sur les formulaires et reçus
  ...
  //  $reqe->execute();
    ...
    if (isset($_POST['DEBITCPT'])){
          $_SESSION['DEBITCPT'] = $_POST['DEBITCPT'];        
    }
?>
                ...
                <div class="main-content">
                    <div class="container">
                        ...
                        <div class="row " style="margin-top: 2.5%; border-bottom: 2px solid #8C001A;">
                            <form name="fiche_verb" method="POST" action="recu_caisse_solde.php"> 
                                <div class="col-sm-3" >
                                            ...
                                            <table width="100%" border="0">  
                                                <tr>
                                                    ...
                                                    <td><input id="idverba" input readonly="readonly" class="form-control" value="<?php
                                                        if (!isset($_SESSION['idverba'])) {
                                                            
                                                        } else {
                                                            echo $_SESSION['idverba'];
                                                        }
                                ...
                                <div class="col-md-4">
                                 ...
                                 <!--               <tr class='clickable-row' data-href='detail_verbalisation.php? nfv=<?php //echo $re['ID_VERB']; ?>' style="cursor: pointer;">      -->
                                                <tr>
                                                    ...
                                                    <td>
                                                    <input type="text" name="MONTANT_A_PAYE" id="mp" readonly="readonly"  required placeholder="" class="form-control" value="<?php echo $_SESSION['MONTANT_A_PAYE'] ;?>" />                                                           
                                                    </td>
                                                </tr>   
												<tr>
                                                    <td><label class="col-sm-10 control-label" for="form-field-5">
                                                    ...
                                                    <td>
                                                    <input type="text" name="MONTANT_SOLDE" id="ms" required placeholder="" onchange="restfunc('mt','mp','ms','mr','apt');" class="form-control" value="" onkeyup="valid(this)" onblur="valid(this)"/>                                                           
                                                    </td>
                                                </tr> 												
                                                <tr>
                                                    <td><label class="col-sm-10 control-label" for="form-field-5">
                                                    ...
                                                    <td>
                                                        <input style="width: 100%" type="text" name="MONTANT_RESTANT"  id="mr" placeholder="" readonly="readonly" class="form-control" value="<?php echo $_SESSION['MONTANT_RESTANT'] ;?>"  /> 
                                                    </td>
                                                </tr>   
                                                <?php         
                                                    ...
                                                    <td colspan="1">
                                                      <div align="left">
                                                        <label class="checkbox-inline" for="form-field-5">
                                                            <input type="checkbox" name="typepaie" class="flat-red" checked="true" id="ch" readonly="readonly" onClick="changes('ch','cpt','apt');"/> 
                                                            <td><label class="control-label" for="form-field-5" id="espece" style="width: 50%;">
