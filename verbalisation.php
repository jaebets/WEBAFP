...
if ($_SESSION['ApplicationExtSurcharge'] == 1) {
    ...
    $q->execute(array(':ID_VERB' => $_SESSION['num_verb'],
        ...
        ':AMENDE_TOTAL' => round($_SESSION['bill']),
        ...
        ':POIDS_TOTAL' => round($_SESSION['poid_total']),
        ...
        ':EXCEDENT_ENREGISTRE' => round($_SESSION['surcharge_Vehicule_Pesee']),
        ':SEUIL_EXTREME_SURCHARGE' => $_SESSION['seuil_ext_surc'],
        ':EXTREME_SURCHARGE' => round($_SESSION['value_extreme_surcharge']),
        ':SURCHARGE' => round($_SESSION['value_surcharge']),
        ':OVERLOAD_NAME' => $_SESSION['overload_name'],
        ':OVERLOAD_MASS' => round($_SESSION['overload_mass']),
        ':OVERLOAD_FINE' => round($_SESSION['prix_pesee_simple']),
        ':COMPTE_CLIENT' => $_POST['dyp'],
        ':TRAITE' => 0,
        ':HEURE_VERBALISATION' => $heure_affectation,
		':TYPE_VERBALISATION' => $type));
