                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="page-header">
                                <h1>
                                    Tableau de Bord <small>Audit & Statistique </small></h1>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <a href = "rapport_verbalisation.php"  class="btn btn-icon btn-block">
                                                <i class="fa fa-group"></i>
                                                VERBALISATIONS<!--PES&Eacute;ES--> <span class="badge badge-danger"> <i class="fa fa-group"></i> </span>
                                            </a>
                                        </div>
                                        <div class="col-sm-3">
                                            <a href = "stat_int.php" class="btn btn-icon btn-block" disabled>
                                                <i class="clip-user-5"></i>
                                                FINANCES <span class="badge badge-danger"> <i class="clip-user-5"></i> </span>
                                            </a>
                                        </div>
                                        <div class="col-sm-3">

                                            <a href = "stat_nat.php"  class="btn btn-icon btn-block" disabled>
                                                <i class="fa fa-group"></i>
                                                AUDIT <span class="badge badge-danger"> <i class="fa fa-group"></i> </span>
                                            </a>
                                        </div>
                                        <div class="col-sm-3">
                                            <a href = "statistique.php" class="btn btn-icon btn-block" >
                                                <i class="clip-user-5"></i>
                                                STATISTIQUES<!--RECHERCHE--> <span class="badge badge-danger"> <i class="clip-user-5"></i> </span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
