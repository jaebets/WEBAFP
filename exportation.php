                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <a href = "liste_verbalisation.php" class="btn btn-icon btn-block">
                                                ...
                                                Export Liste des Verbalisations <span class="badge badge-danger"> <i class="fa fa-shopping-cart "></i> </span>
                                            </a>
                                        </div>
										<div class="col-sm-2">
                                            <a href = "liste_paiement.php" class="btn btn-icon btn-block">
                                                <i class="fa fa-shopping-cart "></i>
                                                Export Liste des Paiements <span class="badge badge-danger"> <i class="fa fa-shopping-cart "></i> </span>
                                            </a>
                                        </div>
										<div class="col-sm-2">
                                        ...
                                        <!--
                                        <div class="col-sm-4">
                                            <a href = "utilisateur_site.php" class="btn btn-icon btn-block" disabled>
                                                <i class="clip-user-5"></i>
                                                Compte Client <span class="badge badge-danger"> <i class="clip-user-5"></i> </span>
                                            </a>
                                        </div>
                                        -->
                                        <div class="col-sm-2">
