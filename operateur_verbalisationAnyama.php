                            ...
                            if ($app_ext_sur == 1) {
                                ...
                                <div class="row" style="margin-top: 0.5%; border-bottom: 2px solid #8C001A;">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($grpe_ess as $gp_es) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                            echo round($gp_es['poids_GP']* (1 - $tolerance /100));
															//echo ($gp_es['poids_GP']);
                                                            ?>
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="col-md-6">
                                                ...
                                                foreach ($grpe_ess as $g_e) {
                                                    ...
                                                    foreach ($ess as $es) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                echo round($es['poidsMesure_EP']* (1 - $tolerance /100));
                                                                ?>
                                                            </td>
                                                            <td>
                                        ...
                                        $sql = $dbh->query('select max((e."poidsMesure_EP"*(0.98))-e."poidsMax_EP") as "high" ,e."nom_EP" as "bigest_overload_ep"
...
and p."Numero_Pesee"= ' . $_SESSION['num_pesee'] . ' group by g."nom_GP" order by "high_gp" desc rows 1');
										...
										//
										$sql_gp2 = $dbh->query('select  max((g."poids_GP"*(0.98))-g."poidsMax_GP") as "high_gpT",    g."nom_GP" as "bigest_overload_gp2"
 from "Mobile_Pese" a,"Group_Pese" g,"Vehicule_Pese" v,"Pesee" p 
where g."id_MP"=a."id_MP" 
and a."id_VP"=v."id_VP" and 
p."Id_VP"=v."id_VP" 
                                                    ...
                                                    $_SESSION['surcharge_gp_essieux'] = $result_gp['high_gp'];
                                                           ...
                                                           /* if ($result_gp['high_gp'] < 0) {
                                                            ...
                                                            <tr>
														        ...
														        if (($confimationEP - $essieux['poidsMax_EP']) >= 0) { 
																 ...
																 $_SESSION['surcharge_essieux'] =  round($val_sur);
																  echo round($val_sur);
                                                                } else   
                                                               if (($confimationEP - $essieux['poidsMax_EP']) < 0) { 
                                                                   $val_sur= 0;
                                                        ...
                                                        <table width="100%" border="0" style=" margin-top:0%">
														 ...
														 <table align="left" style="margin-top:1%">
                                                            <tr>
                                                                <td><div align="left"><strong> *VOUS BENEFICIEZ D'UNE TOL&Eacute;RANCE DE 5%  </strong></div></td>
